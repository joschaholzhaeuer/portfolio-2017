...
gulp.task('watch', function() {
    browserSync.init({
      proxy: 'localhost/workspace/portfolio-2017/dist/'
    });
...
// Default Tasks
gulp.task('default', ['copy-folders', 'sass', 'scripts', 'html', 'watch']);

// Default Tasks
gulp.task('build', ['copy-folders', 'sass', 'css', 'lint', 'scripts', 'htmlmin', 'imagemin']);